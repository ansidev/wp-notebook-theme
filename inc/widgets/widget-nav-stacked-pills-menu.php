...
class Nav_Stacked_Pills_Menu_Widget extends WP_Nav_Menu_Widget
{
    ...
    function __construct()
    {
        ...
        WP_Widget::__construct(
            ...
            __('Stacked Pills Menu', 'notebook'),
            array(
                'description' => __('Custom menu widget using Nav Stacked Pills styling', 'notebook')
            )
        );
    }
    ...
    function wp_nav_menu_args($args)
    {
        ...
        return apply_filters('notebook_stacked_pills_menu_args', $args);
    }
    ...
    function form($instance)
    {
        ...
        ?>
        <p>
            <label for="<?php echo $this->get_field_id('well'); ?>"><?php echo __('Has Container', 'notebook'); ?></label>
